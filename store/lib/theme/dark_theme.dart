...
ThemeData dark = ThemeData(
  ...
  textButtonTheme: TextButtonThemeData(style: TextButton.styleFrom(foregroundColor: const Color(0xFF010d75))),
  colorScheme: const ColorScheme.dark(primary: Color(0xFF010d75), secondary: Color(0xFF010d75)).copyWith(error: const Color(0xFFdd3135)),
