...
class AppConstants {
  static const String appName = 'Delivryz Executive App';
  static const double appVersion = 3.5; ///Flutter sdk 3.35.6

  static const String fontFamily = 'Roboto';
  static const String baseUrl = 'https://admin.delivryz.com';
